...
class AssistantsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'phone' => ['type' => 'string', 'length' => 100, 'null' => true, 'default' => null, 'collate' => 'utf8_spanish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public $records = [
        [
            ...
            'country_id' => 1,
            'created' => '2017-02-05 02:02:48',
            'modified' => '2017-02-05 02:02:48',
            'active' => 1
        ],
    ];
}
